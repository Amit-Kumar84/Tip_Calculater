package com.kotlinproject.tiptime
...
import com.kotlinproject.tiptime.ui.theme.TipTimeTheme
...
fun TipTimeLayout() {
    ...
    // Display the formatted tip to the user
    Column(
        modifier = Modifier
            .padding(48.dp)
        ...
        Text(
            ...
            modifier = Modifier
                .padding(bottom = 16.dp)
                .align(alignment = Alignment.Start).fillMaxWidth()
        )
...
private fun calculateTip(
    ...
    var tip = tipPercentage / 100.0 * amount
    if (roundUp) {
